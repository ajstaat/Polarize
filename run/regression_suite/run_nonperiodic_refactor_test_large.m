function run_nonperiodic_refactor_test_large
clc;

fprintf('=== nonperiodic refactor regression test: larger supercell ===\n');

[crystal, model, opts0, ~, molA, molB] = make_standard_nonperiodic_case([3 2 1]);
