...
params_iter.scf.use_thole = true;
...
if isfield(res_dir, 'direct') && isfield(res_dir.direct, 'condition_estimate')
    fprintf('Condition estimate = %.16e\n', res_dir.direct.condition_estimate);
end