...
for i = 1:(n - 1)
    ...
    for j = (i + 1):n
        ...
        if spatial.isPeriodic
            dr = local_minimum_image(dr, spatial.cell);
        end
...
function dr = local_minimum_image(dr, cellMat)
%LOCAL_MINIMUM_IMAGE Minimum-image displacement under row-lattice convention.
%
% Project convention:
%   cart = frac * cellMat
