...
%   - Adjacency is returned as SPARSE to avoid dense O(N^2) memory cost.
...
% Keep only accepted bonds as an undirected edge list, then build sparse A.
I = zeros(nPairs, 1, 'uint32');
J = zeros(nPairs, 1, 'uint32');
nKeep = 0;
